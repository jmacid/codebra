      ...
      <nav className="navbar">
        ...
        <div className="nav-links">
          <ul className="link-list">
            <li className="link-item"><Link to="#Statistics">Estadisticas</Link></li>
            <li className="link-item"><Link to="#About">Acerca</Link></li>
            <li className="link-item"><Link className="CTA-link" to="/snake">Jugar</Link></li>
          </ul>
        </div>
